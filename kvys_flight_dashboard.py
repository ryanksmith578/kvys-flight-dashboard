...
with st.spinner("Fetching weather data…"):
    try:
        ...
        # Use local time for sun angle window
        now_local = datetime.now(ZoneInfo("America/Chicago"))
        sun_start_utc, sun_end_utc = get_sun_window(kvys_lat, kvys_lon, now_local.date())
        sun_start_local = sun_start_utc.astimezone(ZoneInfo("America/Chicago"))
        sun_end_local = sun_end_utc.astimezone(ZoneInfo("America/Chicago"))
        ...
        st.write(f"Local time: **{sun_start_local.strftime('%I:%M %p')} – {sun_end_local.strftime('%I:%M %p')}**")
